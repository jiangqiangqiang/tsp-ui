<template>
  <div class="top-up-main">
    ...
    <TransactionDetail title="补贴金额回单" :trade-type="basicInfo.transactionType" :trade-time="basicInfo.transactionTime"
      ...
      <div class="current-content">
        <div class="title-style">补贴企业 : {{basicInfo.relatedPartyName}}</div>
        <div class="title-style">统一社会信用代码 : {{basicInfo.relatedPartyCreditCode}}</div>
        <div class="title-style">
          补贴金额 : {{basicInfo.amount | toThousands}}
