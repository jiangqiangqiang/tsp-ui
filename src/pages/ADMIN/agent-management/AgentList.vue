<template>
  <div class="agent-list-main">
    <BusinessTitle title="代理商列表"></BusinessTitle>
    <div class="minpad">
    <div class="agent-list-filtrate">
      <div class="agent-name">
        <span style="padding-right: 10px">代理商名称</span>
      ...
      <div class="agent-name">
        <span style="padding-right: 10px">服务商名称</span>
        <input type="text" class="agent-name-input" v-model="filtrate.serviceName">
      </div>
      <div>
        <div class="state-type">
          <span class="state-type-title">状态</span>
          <el-select clearable v-model="filtrate.transactionType" style="padding-left: 10px">
    ...
    <el-main style="padding:0">
      <el-table :data="agentListData" border stripe header-align='center'
        ...
        <el-table-column prop="enterpriseName" label="代理商企业名称">
        </el-table-column>
        <el-table-column prop="creditCode" label="统一社会信用代码">
        </el-table-column>
        <el-table-column prop="serviceName" label="服务商">
        </el-table-column>
        <!-- <el-table-column
            width="180"
            prop="landLine"
        ...
        <el-table-column prop="createdOn" label="开户日期" width="130">
        </el-table-column>
