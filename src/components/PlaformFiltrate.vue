<template>
  <div class="filtrate">
    <div style="width: 100%; height: 38px;padding-top: 14px">
      ...
      <div class="related-party">
        <span class="title-amount-sale">交易主体</span>
        <el-input type="text" clearable class="related-party-input" v-model="filtrate.enterpriseName"></el-input>
      </div>
      <div class="related-party">
        <span class="title-amount-sale">关联方</span>
        <el-input type="text" class="related-party-input bigW" v-model="filtrate.relatedPartyName"></el-input>
      </div>
      ...
      <div class="transaction-number">
        ...
        <el-input type="text" clearable class="transaction-number-input" v-model="filtrate.transactionCode"></el-input>
      </div>
    ...
    <div style="width:100%; height:38px">
      ...
      <div class="transaction-number" style="paddingLeft:49px">
        <span style="padding-right: 20px">交易编号</span>
        <el-input type="text" clearable class="transaction-number-input" v-model="filtrate.transactionCode"></el-input>
      </div>
      <div class="trade-type" style="paddingLeft:49px">
        <span class="trade-type-title">交易类型</span>
        <el-select clearable v-model="filtrate.transactionTypes" style="padding-left: 20px">
          <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </div> -->
